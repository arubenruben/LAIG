...
class MyGameBoard extends CGFobject {
    constructor(orchestrator, x1, z1, x2, z2) {
        ...
        this.player1_stash = new MyAuxiliarBoard(orchestrator, null, null, null, null, this.tiles_width, this.tiles_height, 1);
        this.player2_stash = new MyAuxiliarBoard(orchestrator, null, null, null, null, this.tiles_width, this.tiles_height, 2);
